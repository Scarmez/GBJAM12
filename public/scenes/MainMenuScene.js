...
export class MainMenuScene extends Scene {
    ...
    create() {
        ...
        this.mainMenu = this.addGameobject(new MenuObject(Game.i.defaultBorder, 32, 96, 96, 40));
        ...
        let palettePicker = new UIHorizontalPickerObject("Pallete: ", Game.i.assets.getSprite("font"));
        ...
        let windowPicker = new UIHorizontalPickerObject("Window: ", Game.i.assets.getSprite("font"));
        ...
        this.optionMenu = this.addGameobject(new MenuObject(Game.i.defaultBorder, 0, 96, 160, 48));
        ...
        this.controlsMenu = this.addGameobject(new MenuObject(Game.i.assets.getSprite("frame0"), 0, 0, 160, 144));

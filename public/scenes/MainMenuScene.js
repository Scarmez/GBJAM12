...
export class MainMenuScene extends Scene {
    ...
    create() {
        ...
        this.mainMenu = this.addGameobject(new MenuObject(defaultFrameName, "cursor", 32, 96, 96, 40));
        ...
        this.optionMenu = this.addGameobject(new MenuObject(defaultFrameName, "cursor", 0, 96, 160, 48));

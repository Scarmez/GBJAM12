...
export class RewardScene extends Scene {
    ...
    constructor() {
        ...
        this._scoreText = this.addGameobject(new TextObject("Score:", "font_rabbit", 0, 24, 1));
        ...
        for (let i = 0; i < 5; i++) {
            this._potionObjs.push(this.addGameobject(new SpriteObject(32 + i * 17, 112, 0, 0, "health_potion")));
        }

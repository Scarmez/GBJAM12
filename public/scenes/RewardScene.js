...
export class RewardScene extends Scene {
    ...
    constructor() {
        ...
        this._songNameText = this.addGameobject(new TextObject("Well Done!", "font_rabbit", 0, 8));
        this._scoreText = this.addGameobject(new TextObject("Score:", "font_rabbit", 0, 32, 1));
        this._petObj = this.addGameobject(new AnimatedSpriteObject(0, 0, 0, 0, "c1_final", creature, true));
        ...
        for (let i = 0; i < 5; i++) {
            ...
            this._potionObjs.push(this.addGameobject(new SpriteObject(38 + i * 18, 116, 0, 0, SaveData.getPotionSprite())));
        }
        this._poop = this.addGameobject(new AnimatedSpriteObject(72, 116, 0, 0, "poop", poop_anim, true));
        ...
        if (SaveData.saveObj.petHappiness <= 0)
            SaveData.saveObj.petHappiness = 0;

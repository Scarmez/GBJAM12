...
export class HomeScene extends Scene {
    ...
    constructor() {
        ...
        this._cauldron = new AnimatedSpriteObject(56, -4, 0, 0, "smol_cauldron", smol_cauldron_anim, true);
        this._creatureObj = this.addGameobject(new AnimatedSpriteObject(0, 0, 0, 0, SaveData.getCreatureSprite(), creature_anim, true));
        ...
        feedButton.onHover = () => { feedButton.getComponent("SpriteRenderer").setFrame(1, 0); };
        feedButton.offHover = () => { feedButton.getComponent("SpriteRenderer").setFrame(0, 0); };
        ...
        playButton.onHover = () => { playButton.getComponent("SpriteRenderer").setFrame(1, 1); };
        playButton.offHover = () => { playButton.getComponent("SpriteRenderer").setFrame(0, 1); };
        playButton.localY = 16;
        playButton.localX = 112;
        playButton.getComponent("SpriteRenderer").setFrame(0, 1);
        ...
        this._petEmotion = this.addGameobject(new AnimatedSpriteObject(72, 40, 0, 0, "emotes", emotes_anim, true));
        this._petEmotion.localY = this._creatureObj.localY - 16;
        this._foodObj = this.addGameobject(new AnimatedSpriteObject(64, 80, 0, 0, "food", food_anim));
        ...
        this._ballObj = this.addGameobject(new AnimatedSpriteObject(64, 80, 0, 0, "ball_toy", ball_toy_anim));
        ...
        this._ballObj.animationController.addOnEndEvent(() => {
            ...
            if (SaveData.saveObj.petHappiness > 100)
                SaveData.saveObj.petHappiness = 100;
            SaveData.save();
            this.updateStats();
            this._ballObj.setEnabled(false);
            this._petEmotion.setEnabled(true);

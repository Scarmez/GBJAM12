...
export class HomeScene extends Scene {
    ...
    constructor() {
        ...
        this._creatureObj = this.addGameobject(new AnimatedSpriteObject(0, 0, 0, 0, SaveData.getCreatureSprite(), creature, true));
        ...
        this._shop_bg = this.addGameobject(new SpriteObject(16, 8, 0, 0, "shop_bg"));

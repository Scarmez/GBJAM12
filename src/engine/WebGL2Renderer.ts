...
export class WebGL2Renderer extends Renderer {
    ...
    private _paletteLocation: WebGLUniformLocation;
    private _textureMatrixLocation: WebGLUniformLocation;

    constructor(gfxManager: GraphicsManager, context: WebGL2RenderingContext){
    ...
    private createProgramFromSources(gl: WebGL2RenderingContext, vertexSource: string, fragmentSource: string): WebGLProgram|null {
    ...
    private createProgram(gl: WebGL2RenderingContext, shaders: WebGLShader[]): WebGLProgram|null {
    ...
    private loadShader(gl: WebGL2RenderingContext, shaderSource: string, shaderType: number): WebGLShader|null {
        ...
        if(gl.getShaderInfoLog(shader)) console.log(gl.getShaderInfoLog(shader));
    ...
    public drawImage(
        ...
        if (srcWidth === undefined) { srcWidth = sprite.frameWidth; }
        if (srcHeight === undefined) { srcHeight = sprite.frameHeight; }
